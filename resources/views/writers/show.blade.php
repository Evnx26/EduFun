...
@section('konten')
    <main class="main flex-grow-1">
        <div class="container-fluid pt-4 d-flex gap-3">
            <img src="{{ $writer->avatar }}" alt="content" class="img-fluid object-fit-cover mb-2 rounded-circle" style="width: 10%">
            <a href="{{ route('writer.index') }}" class="text-center d-flex flex-column justify-content-between py-3 text-decoration-none text-dark">
                    <h3>{{ $writer->name }}</h3>
